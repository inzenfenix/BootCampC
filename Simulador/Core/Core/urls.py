...
urlpatterns = [
    ...
    path('PorcentajeAccidentes/', views.Cantidad_Accidente_total.as_view(),name='Cantidad Accidente por tipo'), #Servicio 1
    ...
    path(f'AccidentesFechaSexo/<desde>/<hasta>/<sexo>/', views.Accidentes_Fecha_Sexo.as_view(),name='Accidente fecha sexo'), #Servicio 11
    path(f'FechaSexoEmbarazo/<fecha>/<sexo>/', views.Fecha_sexo_embarazo.as_view(),name='Fecha sexo embarazo'), #Servicio 12
    path(f'AccidenteFechaEmbarazoEdad/<sexo>/<edad>/', views.Accidentes_sexo_embarazo_edad.as_view(),name="Accidentes sexo embarazo edad"), #Servicio 13
