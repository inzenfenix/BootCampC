...
void SetAccidents(int type)
{
   ...
   {
      case 0:
         accidentsTypes[type].Accidentes[0].descripcion = "Piso estaba humedo y provocó una caida, la gravedad de la mismano quedó clara pero señaló tener una molestia en la espalda";
         accidentsTypes[type].Accidentes[0].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[0].dias_perdidos = 7;
         ...
         accidentsTypes[type].Accidentes[1].dias_perdidos = 7;
         ...
         accidentsTypes[type].Accidentes[3].dias_perdidos = 7;
         ...
         accidentsTypes[type].Accidentes[4].dias_perdidos = 7;
         break;
      case 1:
      ...
      case 2:
         ...
         break;
      case 3:
         accidentsTypes[type].Accidentes[0].descripcion = "En reunión de sindicato una mesa plegable se rompe y cayó sobre las piernaslesionando gravemente.";
         accidentsTypes[type].Accidentes[0].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[0].dias_perdidos = 7;
         ...
         accidentsTypes[type].Accidentes[2].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[2].dias_perdidos = 7;
         accidentsTypes[type].Accidentes[3].descripcion = "En reunión de sindicato una mesa plegable se rompe y cayó sobre las piernaslesionando gravemente.";
         accidentsTypes[type].Accidentes[3].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[3].dias_perdidos = 7;
      ...
      case 5:
         ...
         accidentsTypes[type].Accidentes[0].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[0].dias_perdidos = 7;
         accidentsTypes[type].Accidentes[1].descripcion = "Empleado sufre violencia en transporte camino a la oficina";
         accidentsTypes[type].Accidentes[1].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[1].dias_perdidos = 7;
      ...
      case 6:
         ...
         accidentsTypes[type].Accidentes[1].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[1].dias_perdidos = 7;
         accidentsTypes[type].Accidentes[2].descripcion = "Persona externa ingresa a oficina y atacó a empleado";
         accidentsTypes[type].Accidentes[2].procedimiento_aplicado = 0;
         accidentsTypes[type].Accidentes[2].dias_perdidos = 7;
